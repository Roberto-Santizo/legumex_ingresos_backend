...
import { People } from "../../models/VisitsModule";
...
export const updatePeople = async (req: Request, res: Response) => {
    try {
        ...
        const updateData: Partial<Pick<People,
            'name' | 'document_number' | 'document_photo_front' | 'document_photo_back' | 'license_number' | 'license_photo'
        >> = {}
