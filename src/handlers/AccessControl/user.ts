...
import { User, Role } from "../../models/AccessControl"
import bcrypt from "bcrypt"
import { Department } from "../../models/VisitsModule"
...
export const createUser = async (req: Request, res: Response) => {
   try {
      ...
      const newUser = await User.create({ ...rest, username, password: hashedPassword })
